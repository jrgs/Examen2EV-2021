...
namespace Ejercicio10
{
    public partial class Form1 : Form
    {
        ...
        //
        const double JVP2021CONV1 = 0.826;  // 1 dolar, 0,826 euros
        const double JVP2021CONV2 = 1.1485; // 1 libra, 1,1485 euros
